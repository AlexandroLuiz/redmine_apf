...
Contudo, como este plugin necessita de algumas tabelas no banco de dados, a partir do diretório de Redmine, deve ser executado o seguinte comando no console:
